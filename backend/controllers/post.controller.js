...
export const commentOnPost = async (req, res) => {
	try {
		...
		const comment = { user: userId, text };//see schema for this
...
export const likeUnlikePost = async (req, res) => {
	try {
		...
		if (userLikedPost) {
			...
			await User.updateOne({ _id: userId }, { $push: { likedPosts: postId } });//to get/not get liked posts of a user
